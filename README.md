...
<img src="https://komarev.com/ghpvc/?username=Miau44&style=for-the-badge&color=blue" alt="Visitas al perfil">
...
flowchart LR
    ...
    subgraph FRONTEND["Capa Frontend"]
        UI["Angular · React · Vue · Flutter"]
    end

    UI --> API

    subgraph BACKEND["Backend y Lógica de Negocio"]
        API["APIs REST"]
        DOTNET["C# · .NET"]
        NODE["Node.js · NestJS"]
        PHP["Laravel · PHP"]
    ...
    subgraph DATA["Capa de Datos"]
        DB["Servicios de Bases de Datos"]
